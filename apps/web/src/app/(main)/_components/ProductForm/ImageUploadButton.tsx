...
import { EditUploadImagesHookProps } from '../../shop/product/[id]/edit/_type/editUploadImagesProps';
...
const ImageUploadButton = React.memo(
  ({
    ...
    uploadImages: EditUploadImagesHookProps['uploadImages'];
    setUploadImages: EditUploadImagesHookProps['setUploadImages'];
  }) => {
