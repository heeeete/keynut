...
export default function OpenChatLink({ url, session, id }: { url: string; session: Session; id: string }) {
  if (!url)
    return (
      <button
        ...
        className="flex justify-center items-center rounded aspect-square w-7 bg-black opacity-10 cursor-not-allowed"
      >
  ...
  return (
    <Link
      ...
      className="flex justify-center items-center rounded aspect-square w-7 bg-black shadow-button"
