...
export default function OpenChatLink({ url, session, id }) {
  if (!url)
    return (
      <button
        ...
        className="flex justify-center items-center rounded aspect-square w-8 opacity-10 cursor-not-allowed"
      >
  ...
  return (
    <Link
      ...
      className="flex justify-center items-center rounded aspect-square w-8"
